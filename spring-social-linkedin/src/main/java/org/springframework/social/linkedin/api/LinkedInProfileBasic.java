 ...
 * @author Craig Walls
 */
public class LinkedInProfileBasic extends LinkedInObject implements Serializable {
	...
	public LinkedInProfileBasic(String id, String firstName, String lastName, String headline, String industry, String publicProfileUrl, UrlResource siteStandardProfileRequest, String profilePictureUrl) {
		this.id = id;
